    ...
    def post_photo(self, photo_data, caption='', user_tags=None):
        ...
        try:
            ...
            res = self._make_request(
                ...
                params={'upload_id': upload_id, 'caption': caption, 'retry_timeout': '', 'custom_accessibility_caption': ''}\
                    if not user_tags else \
                    {'upload_id': upload_id, 'caption': caption, 'usertags': user_tags_,  'retry_timeout': '', 'custom_accessibility_caption': ''},
